...
class LocalizelyApi {
  ...
  static Future<void> upload(
    ...
    var uri = Uri.parse(
      '$_baseUrl/v1/projects/$projectId/files/upload$queryParams',
    );
    ...
    if (response.statusCode != 200) {
      var formattedResponse = formatJsonMessage(
        await response.stream.bytesToString(),
      );
      throw ApiException(
        'Failed to upload data on Localizely.',
        response.statusCode,
        formattedResponse,
      );
    }
  ...
  static Future<DownloadResponse> download(
    ...
    if (response.statusCode != 200) {
      ...
      throw ApiException(
        'Failed to download data from Localizely.',
        response.statusCode,
        formattedResponse,
      );
    }
